...
namespace YtelAPI.Standard.Controllers
{
    public partial class UsageController: BaseController
    {
        ...
        /// </summary>
        /// <param name="Models.CreateUsageListusageInput">Object containing request parameters</param>
        /// <return>Returns the string response from the API call</return>
        public string CreateUsageListusage(Models.CreateUsageListusageInput input)
        {
            Task<string> t = CreateUsageListusageAsync(input);
        ...
        /// <param name="Models.CreateUsageListusageInput">Object containing request parameters</param>
        /// <return>Returns the string response from the API call</return>
        public async Task<string> CreateUsageListusageAsync(Models.CreateUsageListusageInput input)
        {
